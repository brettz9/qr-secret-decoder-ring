...
4. Add back external URL support (upon user preference)
5. Could i18n-ize errors, but would also need to modify qrcodedecode.js
*/
                        ...
                        tabs.open({
                            ...
                            onOpen: function (tab) {
                                tab.on('ready', function (tab) {
                                    tab.attach({
                                        contentScriptFile: data.url('insertText.js'),
                                        contentScript: 'insertText("' + text.replace(/"/g, '\\"').replace(/\r?\n/g, '\\n') + '");'
                                    });
                                });
                            }
                        });
