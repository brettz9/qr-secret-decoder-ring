    ...
    var _ = require('sdk/l10n').get,
        ...
        setupDecoderMenuItem = function () {
            ...
            item = cm.Item({
                ...
                context: cm.SelectorContext('img,canvas,svg,video'),
                ...
                onMessage: function (imgSrc) {
                    ...
                    var isVideo = typeof imgSrc === 'object' && imgSrc.videoSrc;
                    if (isVideo) {
                        workerOpts.contentScriptFile = qrDecodeFiles.concat(canvgFiles, 'video-decode.js').map(function (url) {
                            return data.url(url);
                        });
                    }
                    else if (imgSrc.slice(0, 4) === '<svg') {
